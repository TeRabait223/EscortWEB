...
const buttontechSupport = document.querySelector('.button__tech_support')
const techSupport = document.querySelector('.popup__tech_support')
...
function ClickPlus1() {
    if (buttonLikes1.classList.contains('elements__button_active')) {
        let count = 235
        count --
        likes1.innerHTML = `${count}`
        buttonLikes1.classList.remove('elements__button_active')
    } else {
...
function ClickPlus2() {
    if (buttonLikes2.classList.contains('elements__button_active')) {
        let count = 391
        count --
        likes2.innerHTML = `${count}`
        buttonLikes2.classList.remove('elements__button_active')
...
function ClickPlus3() {
    if (buttonLikes3.classList.contains('elements__button_active')) {
        let count = 202
        count --
        likes3.innerHTML = `${count}`
        buttonLikes3.classList.remove('elements__button_active')
    } else {
...
function OpenPopupTechSupport() {
    techSupport.classList.toggle('popup__open')
}

buttontechSupport.addEventListener('click', OpenPopupTechSupport)
